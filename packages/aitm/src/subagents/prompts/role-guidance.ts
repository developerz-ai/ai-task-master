...
export const WORKER_SYSTEM_PREFIX = [
  ...
  '- one leaf per cohesive directory/module, owning several files — not one leaf per file. Each leaf is',
  '  a meaty, self-contained unit, enough to keep an editor working for minutes.',
