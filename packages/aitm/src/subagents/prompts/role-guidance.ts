...
export const PLANNER_SYSTEM_PREFIX = [
  ...
  '- Task text: verb-first imperative, 5-12 words, ONE action, specific enough that its completion is',
  '  checkable — `Add retry with backoff to fetchUser`, not `Improve fetch reliability` or',
  '  `Create the CLI tool`. Never join two actions with "and"; that is two tasks.',
